  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => getIt<MovieDetailsBloc>()
        ...
        ..add(GetMovieRecomindationsEvent(id)),
      child: Scaffold(
...
//  final MovieDetails movie;
  //final List<MoviesRecomendations> recommendations;
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsInitial>(
          ...
          return CustomScrollView(
            ...
            slivers: [
                  ...
                  background: FadeIn(
                    ...
                    child: ShaderMask(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: AppConexstances.imageUrl(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8.0),
                        Text(
                          'Genres: ${_showGenres(state.movieDetails!.genress)}',
                          style: const TextStyle(
                            color: Colors.white70,
                            fontSize: 12.0,
                            fontWeight: FontWeight.w500,
              ...
              SliverPadding(
                ...
                sliver: _showRecommendations(state.MovieRecomendation),
              ),
            ],
          );
  ...
  Widget _showRecommendations(List<MoviesRecomendations> recommendations) {
    return SliverGrid(
        ...
        (context, index) {
          ...
          return FadeInUp(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl:
                    AppConexstances.imageUrl(recommendation.backdrop_path!),
