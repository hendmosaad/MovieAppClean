...
import 'package:movies_app/movies/persentation/component/nowPlayingComponent.dart';
import 'package:movies_app/movies/persentation/component/popularCompnent.dart';
import 'package:movies_app/movies/persentation/component/topRated.dart';
...
class MainMoviesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('build');
    return BlocProvider(
      create: (BuildContext)=>getIt<MoviesBloc>()..add(GetNowPalyingEvent())..add(GetPopularEvent())..add(GetTopRatedEvent()),
      child: Scaffold(
